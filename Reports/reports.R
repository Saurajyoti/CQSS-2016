...
for (j in 15:15){
  course_dataset <- dataset[dataset$A.2..Select.the.name.of.your.Erasmus.Mundus.Joint.Master.Degree..EMJMD.. == tenormore$Course[j],]

  rmarkdown::render('./Reports/report_script.Rmd',  # file 2
                    output_format = "pdf_document",
                    output_file =  paste(as.character(tenormore$Course[j]), '_', Sys.Date(), ".pdf", sep=''), 
